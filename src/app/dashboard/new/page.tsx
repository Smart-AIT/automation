  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-4 sm:px-6 md:px-8 py-4 sm:py-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div className="flex items-center gap-3 sm:gap-4 mt-1 pl-10 md:pl-0">
            <Link
              href="/dashboard"
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Add New Record</h1>
          </div>
          <div className="w-full sm:w-auto pl-10 md:pl-0">
            <input
              type="file"
              accept=".csv,.xlsx,.xls"
              className="hidden"
            ...
            <button
              ...
              className='flex items-center gap-2 bg-blue-500 text-white border border-blue-600 hover:bg-blue-600 px-3 py-2 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base'
            >
